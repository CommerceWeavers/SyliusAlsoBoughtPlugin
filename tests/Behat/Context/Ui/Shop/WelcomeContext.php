...
namespace Tests\CommerceWeavers\SyliusAlsoBoughtPlugin\Behat\Context\Ui\Shop;

use Behat\Behat\Context\Context;
use Tests\CommerceWeavers\SyliusAlsoBoughtPlugin\Behat\Page\Shop\WelcomePageInterface;
